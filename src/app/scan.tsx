...
const styles = StyleSheet.create({
  ...
  modeButton: { flex: 1, padding: 10, borderRadius: 20, backgroundColor: '#222', alignItems: 'center' },
  modeButtonActive: { backgroundColor: '#1565c0' },
  modeText: { color: '#aaa' },
  modeTextActive: { color: '#fff', fontWeight: '600' },
  primaryButton: { backgroundColor: '#2e7d32', padding: 14, borderRadius: 24, alignItems: 'center' },
  primaryButtonText: { color: '#fff', fontWeight: '700' },
  secondaryButton: { flex: 1, backgroundColor: '#333', padding: 14, borderRadius: 24, alignItems: 'center' },
