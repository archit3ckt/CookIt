...
const SEED: Record<SeedId, SeedEntry> = {
  ...
  eggs: { name: 'Eggs', roles: ['protein', 'fat', 'egg'], pairsWith: ['butter', 'cheddar', 'spinach', 'onion', 'tomato', 'flour', 'sugar'], defaultShelfLifeDays: 21, healthScore: 0.75, macros: m(155, 13, 1.1, 11, 124) },
